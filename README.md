...
| 기능                    | 동작                                                                                                        |
| ----------------------- | ----------------------------------------------------------------------------------------------------------- |
| **화면에서 영역 지정**  | F12로 정지 화면을 전체화면에 띄우고 확대경을 보며 드래그합니다. 새 ROI로 추가하거나 기존 영역을 바꿉니다.   |
...
- **검증:** 기존 캡처·좌표 처리의 Windows 10 build 19045 100%·150% 근거는 [0.3.0 검증 기록](docs/local-mvp-verification.md)에 있습니다. 0.4.0의 새 F12 전체화면 선택·확대경은 별도 실기 검증이 필요하며, 과거 결과가 새 선택창까지 검증한 것은 아닙니다.
